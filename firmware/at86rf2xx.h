 ...
 * The driver is aimed to work with the at86rf233 model.
 *
 * @{
 *
 * @file
...
class AT86RF2XX
{
  public:
     ...
     *
     * @param[in] spi_speed     SPI bus speed in Hz
     ...
     * @return                  <0 on error
     */
    int init(uint32_t spi_speed, int cs_pin, int int_pin, int sleep_pin, int reset_pin);
