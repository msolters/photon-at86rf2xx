 ...
 * The driver is aimed to work with just the at86rf233 at present.
 *
 * @{
 *
 * @file
 ...
 *
 * @param[in] spi_speed        SPI bus speed
 ...
 * @return                  <0 on error
 */
int at86rf2xx_init( uint32_t spi_speed,
